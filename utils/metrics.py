...
class asrMetrics(object):
    ...
    def convert_to_char_ctc(self, ys_hat, ys_pad, ilens=None):
        """Convert index to character.
    ...
    def compute_both(self, predictionBatch, targetBatch, ilens=None):
        ...
        if ilens is not None:
            preds, trgts = self.convert_to_char_ctc(predictionBatch.cpu(), targetBatch.cpu(), ilens)
        else:
